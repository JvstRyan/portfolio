  ...
  return (
    <>
      <section className="hero min-h-screen 2xl:-mt-20">
        <article className="hero-content flex-col lg:flex-row-reverse md:ml-20">
          <Image
            src="/3d.svg"
            alt="3d model"
            width={500}
          ...
          <article className="mr-10">
            ...
            <button className="btn btn-secondary text-white btn-wide sm:btn-md text-center ml-7 sm:ml-0 sm:w-40">
              Get in touch
              <BsArrowRight />
            </button>
          </article>
