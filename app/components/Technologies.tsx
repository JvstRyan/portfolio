    ...
    <section className="hero min-h-screen mt-20 ">
        <article className="hero-content flex-col lg:flex-row-reverse sm:ml-16 sm:gap-28">
          ...
          <article className="flex justify-center items-center flex-col gap-10 sm:w-1/3 ">
            ...
            <p className='py6 text-black'>Last year I was mostly using HTML, CSS and Javascript 
               for all my projects, but since then I have grown my frontend expertise out to all different kinds of frameworks and libraries.  
