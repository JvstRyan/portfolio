...
export const ContactForm = () => {
  ...
  return (
    <form ref={form} onSubmit={sendEmail} className="flex flex-col gap-8">
     {alert && <div className="alert alert-success bg-primary">
      ...
      <input
        ...
        type="text"
        name="user_name"
        className="input input-primary w-96 text-black"
      />
      <input
      ...
      />
      <textarea
        className="textarea h-40 textarea-primary text-black w-96"
        name="message"
      />
      <button
        className="btn btn-secondary w-96 text-white"
        type="submit"
        value="Send"
      >
        Submit
