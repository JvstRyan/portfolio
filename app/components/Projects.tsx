        ...
        <article className="hero-content flex-col gap-10 lg:flex-row-reverse">
          ...
          <article className="flex flex-col gap-10 sm:w-1/3 sm:-mt-40 ">
                <article className='flex flex-col items-start gap-5'>
                   ...
                   <p className='text-black text-sm w-86'>I created this portfolio to showcase what my skills that I have built up so far. I am looking forward to showcasing more of my projects.</p>
