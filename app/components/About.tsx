    ...
    <section className="hero min-h-screen mt-20 ">
        <article className="hero-content flex-col gap-x-40 lg:flex-row-reverse md:ml-20 md:mr-20">
          <article className="">
            ...
            <p className="py-6 text-black text-sm  text-center sm:text-left sm:text-sm/[20px]">
            Hi there I’m Ryan Horrmann, a 19-year-old student <br></br> currently persuing a bachelors in Media Design. <br></br> Passionate about web development, <br></br> I find joy in crafting seamless user experiences. <br></br><br></br>
            ...
            <br></br> <br></br>Want to talk about <b> web development, fitness or nintendo?</b>

            </p>
            <button className="btn btn-secondary ml-12 sm:ml-0 text-white btn-wide sm:btn-md text-center">
              Get in touch
              <BsArrowRight />
            </button>
          </article>
